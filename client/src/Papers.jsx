...
function Papers() {
    ...
    const handleSearch = () => {
        ...
        const filteredPaper = papers.filter(paper =>
            (paper.paperName && paper.paperName.toLowerCase().includes(lower)) ||
            (paper.Degree && paper.Degree.toLowerCase().includes(lower))
        );
        setFilteredPapers(filteredPaper);
    };
        ...
        <div className="dashboard-container">
            <aside className="sidebar">
                ...
                <nav className="sidebar-nav">
                    ...
                    <button className="sidebar-link" id="bottone5"
                        style={{ backgroundColor: '#e2e8f0', fontWeight: 'bold', color: '#1e3a8a' }}
                        onClick={() => navigate('/papers')}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-journal-richtext" viewBox="0 0 16 16">
            ...
            <main className="main-content">
                ...
                <div className='header-container'>
                    <h3>Papers</h3>
                    <button className='add-paper' onClick={() => navigate('/addPapers')}>Add Paper</button>
                </div>
                {papers.length === 0 ? (
                    <div>
                        <table className='scheduledClass'>
                            ...
                            <tbody>
                                <tr>
                                    <td><span>No papers have been added yet.</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div>
                        <table className='scheduledClass'>
                            ...
                            <tbody>
                                <tr>
                                    <td colSpan="2"><span>No papers match your search.</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
