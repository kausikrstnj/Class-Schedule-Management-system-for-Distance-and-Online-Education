...
function AddPapers() {
    ...
    const handleSubmit = async (e) => {
        ...
        const formData = { paperName: paperName.trim(), degree: degree.trim() };

        try {
            const response = await fetch("http://localhost:3000/api/addNewPaper", {
                method: "POST",
        ...
        <div className="dashboard-container">
            <aside className="sidebar">
                ...
                <nav className="sidebar-nav">
                    ...
                    <button className="sidebar-link" id="bottone5" style={{ backgroundColor: '#e2e8f0', fontWeight: 'bold', color: '#1e3a8a' }} onClick={() => navigate('/papers')}>
            ...
            <main className="main-content">
                ...
                <div className='add-paper-container'>
                    <form className="modern-form">
                        <div className="form-title">Add Papers</div>
                        <div className="form-body">
                            <div className="input-group">
                                <div className="input-wrapper">
                                    <input required="" value={paperName} id='paperName' placeholder="Paper Name" className="form-input" type="text" onChange={(e) => {
                                        setPaperName(e.target.value);
                                        setErrors({ ...errors, paperName: "" });
                                    }} />
                                </div>
                                {errors.paperName && (
                            ...
                            <div className="input-group">
                                <div className="input-wrapper">
                                    <select name="degree" id="degree" required="" value={degree} className="form-input" onChange={(e) => {
                                        setDegree(e.target.value);
                                        setErrors({ ...errors, degree: "" });
                                    }}>
                                        <option value="">Select Degree</option>
                                        {/* BSc CS */}
                                        <option value="II BSC CS">II BSc CS</option>
                                        <option value="III BSC CS">III BSc CS</option>
                                        {/* BSC IT */}
                                        <option value="II BSC IT">II BSC IT</option>
                                        {/* MSc CS */}
                                        <option value="I MSC CS">I MSc CS</option>
                                        <option value="II MSC CS">II MSc CS</option>
                                        {/* MSC IT */}
                                        <option value="I MSC IT">I MSc IT</option>
                                        <option value="II MSC IT">II MSc IT</option>
                                        {/* MA Economics */}
                                        <option value="I MA Economics">I MA Economics</option>
                                        <option value="II MA Economics">II MA Economics</option>
                                        {/* BA English */}
                                        <option value="I B.A.English">I B.A.English Literature</option>
                                        <option value="II B.A.English">II B.A.English Literature</option>
                                        <option value="III B.A.English">III B.A.English Literature</option>
                                        {/* B.B.A */}
                                        <option value="I B.B.A">I B.B.A</option>
                                        <option value="II B.B.A">II B.B.A</option>
                                        <option value="III B.B.A">III B.B.A</option>
                                        {/* MA English */}
                                        <option value="I M.A.English">I M.A.English</option>
                                        <option value="II M.A.English">II M.A.English </option>
                        ...
                        <button className="submit-button" type="submit" onClick={handleSubmit}>
                            <span className="button-text">Add Paper</span>
